...
function Footer() {
  return (
    <div data-scroll data-scroll-speed="-0.1" className='relative flex w-full h-[120vh] bg-zinc-100 pt-36 px-14'>
        <div  className='flex flex-col justify-between w-1/2 h-[96vh]'>
            <div className=''>
            <h1 className='text-[7vw] font-bold uppercase -tracking-[.06em] leading-[.80]'>Eye-</h1>
            <h1 className='text-[7vw] font-bold uppercase -tracking-[.06em] leading-[.80]'>opening</h1>
            </div>
            <svg width="100" height="35" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2 h-[96vh]'>
              <div className='w-full'>
              <h1 className='text-[6.5vw] font-bold uppercase -tracking-[.06em] leading-[.80]'>presentations</h1>
              </div>
              <div className='w-full h-[85vh] flex '>
                <div className='flex flex-col justify-between pt-10 w-1/2'>
